		...
		sections: [
			...
			},
			{
				...
				blocks: [
					...
					{ type: "paragraph", text: "The series page also shows the current recurring agreement and any revision awaiting approval. Use **Revise agreement** to create a fresh draft from the approved agreement. The approved source and already billed visits stay unchanged while you edit and collect approval for the revision." },
