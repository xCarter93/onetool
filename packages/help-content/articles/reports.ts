		...
		sections: [
			...
			},
			{
				...
				blocks: [
					...
					{
						type: "note",
						text: "Picking a chart type applies a sensible grouping for you if none is set; change it under **Group by**. **None (raw rows)** is available on Table reports only, since a chart needs grouped data to draw.",
					},
					{
						type: "note",
