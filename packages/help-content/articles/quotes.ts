		...
		sections: [
			...
			},
			{
				...
				blocks: [
					...
					{ type: "paragraph", text: "When you set up or revise a recurring agreement, OneTool saves the proposed service scope, cadence, billing rhythm and payment schedule. Reopening setup restores those saved terms so you can continue the same proposal. Preparing it creates the approval PDF; the series page tells you separately when that PDF is ready to send and when the client is awaiting approval." },
