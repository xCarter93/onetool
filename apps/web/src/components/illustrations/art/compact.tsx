  ...
  return (
    <>
      ...
      <rect
        ...
        className="illo-outline"
      />
      <path d="M19 36 L19 43 L27 36 Z" className="illo-surface" />
      <path d="M19 36 L19 43 L27 36 Z" className="illo-outline" />
      <rect
        x="42"
        y="6"
        width="30"
...
export function ClientPropertiesNoneSm() {
  return (
    <>
      <line x1="12" y1="42" x2="68" y2="42" className="illo-ground" />
      <path d="M26 24 L40 13 L54 24 V42 H26 Z" className="illo-surface" />
      <path d="M26 24 L40 13 L54 24 V42 H26 Z" className="illo-outline" />
      <rect
        x="35"
        y="31"
        width="10"
      ...
      <rect
        ...
        className="illo-outline"
      />
      <circle cx="40" cy="6" r="4.5" className="illo-accent" />
      <circle cx="40" cy="6" r="1.6" className="illo-knock" />
    </>
  );
}
