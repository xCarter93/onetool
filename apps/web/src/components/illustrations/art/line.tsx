...
export function ClientPropertiesNone() {
	return (
		<>
			...
			<rect x="88" y="72" width="24" height="24" rx="3" className="illo-knock" />
			<rect x="88" y="72" width="24" height="24" rx="3" className="illo-outline" />
			<rect x="72" y="66" width="12" height="10" rx="2" className="illo-hair" />
			<rect x="116" y="66" width="12" height="10" rx="2" className="illo-hair" />
...
export function QuoteApprovalNone() {
	return (
		<>
			...
			<path d="M126 86 l4.4 4.4 l8 -9" className="illo-accent-line" strokeWidth={2.2} />
		</>
	);
}
	...
	return (
		<>
			...
			<rect
				...
				transform="rotate(-7 96 65)"
			/>
			<rect x="56" y="30" width="104" height="62" rx="9" className="illo-knock" />
			<rect x="56" y="30" width="104" height="62" rx="9" className="illo-outline" />
			<line x1="56" y1="46" x2="160" y2="46" className="illo-outline" />
			<rect x="68" y="58" width="18" height="13" rx="3" className="illo-accent-soft" />
			<rect x="68" y="58" width="18" height="13" rx="3" className="illo-accent-line" />
	...
	return (
		<>
			...
			<path
				...
				className="illo-dash"
			/>
			<rect x="30" y="46" width="30" height="28" rx="6" className="illo-surface" />
			<rect x="30" y="46" width="30" height="28" rx="6" className="illo-outline" />
			<line x1="38" y1="56" x2="52" y2="56" className="illo-bar-quiet" />
			<line x1="38" y1="64" x2="47" y2="64" className="illo-bar-quiet" />
			<rect x="92" y="42" width="32" height="36" rx="8" className="illo-accent-soft" />
			<rect x="92" y="42" width="32" height="36" rx="8" className="illo-accent-line" />
...
export function MessagesNone() {
	return (
		<>
			<rect x="34" y="30" width="80" height="50" rx="10" className="illo-surface" />
			<rect x="34" y="30" width="80" height="50" rx="10" className="illo-outline" />
			...
			<rect x="102" y="20" width="66" height="44" rx="10" className="illo-accent-soft" />
			<rect x="102" y="20" width="66" height="44" rx="10" className="illo-accent-line" />
			<path
				d="M150 64 L150 76 L134 64 Z"
				className="illo-accent-line illo-fill-knock"
			/>
			<line x1="114" y1="34" x2="152" y2="34" className="illo-bar-accent" opacity={0.45} />
			<line x1="114" y1="46" x2="140" y2="46" className="illo-bar-accent" opacity={0.3} />
		</>
	);
}
	...
	return (
		<>
			...
			<rect
				...
				transform="rotate(-8 85 62)"
			/>
			<rect x="78" y="20" width="70" height="78" rx="7" className="illo-knock" />
			<rect x="78" y="20" width="70" height="78" rx="7" className="illo-outline" />
...
export function SelectConversation() {
	return (
		<>
			<rect x="30" y="20" width="52" height="80" rx="7" className="illo-surface" />
			<rect x="30" y="20" width="52" height="80" rx="7" className="illo-outline" />
			<line x1="40" y1="34" x2="70" y2="34" className="illo-bar-quiet" />
			<rect x="36" y="44" width="40" height="14" rx="4" className="illo-accent-soft" />
			<line x1="42" y1="51" x2="66" y2="51" className="illo-bar-accent" opacity={0.5} />
...
export function AppError() {
	return (
		<>
			...
			<circle cx="150" cy="34" r="12" fill="var(--destructive)" opacity={0.14} />
			<path
...
export function AppErrorHero() {
	return (
		<>
			...
			<circle cx="238" cy="52" r="20" fill="var(--destructive)" opacity={0.14} />
			<path
