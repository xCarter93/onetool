...
export function QuoteSigned() {
	return (
		<>
			<ellipse cx="100" cy="102" rx="46" ry="7" className="illo-mote" opacity={0.13} />
			...
			<path d="M139 26 l5 5 l9 -11" className="illo-celebrate-line" strokeWidth={2.6} />
		</>
	);
}
...
export function InvoicePaid() {
	return (
		<>
			<ellipse cx="100" cy="104" rx="44" ry="7" className="illo-mote" opacity={0.13} />
			...
			<path d="M138 78 L138 86 L100 106 L100 98 Z" className="illo-face-right" />
			...
			<path d="M78 40 L100 28 L122 40 L100 52 Z" className="illo-celebrate-soft" />
			<path d="M78 40 L100 28 L122 40 L100 52 Z" className="illo-celebrate-line" />
			<path
...
export function FirstClientAdded() {
	return (
		<>
			<ellipse cx="100" cy="104" rx="48" ry="7" className="illo-mote" opacity={0.13} />
			...
			<path d="M146 68 L146 78 L100 104 L100 94 Z" className="illo-face-right" />
...
export function AllCaughtUp() {
	return (
		<>
			<ellipse cx="100" cy="102" rx="44" ry="7" className="illo-mote" opacity={0.13} />
			...
			<path d="M144 70 L144 80 L100 104 L100 94 Z" className="illo-face-right" />
			...
			<path d="M92 34 l6 6 l11 -13" className="illo-celebrate-line" strokeWidth={3} />
...
export function AllCaughtUpHero() {
	return (
		<>
			<ellipse cx="160" cy="164" rx="72" ry="11" className="illo-mote" opacity={0.13} />
			...
			<path d="M90 112 L90 128 L160 166 L160 150 Z" className="illo-face-left" />
			<path d="M90 112 L90 128 L160 166 L160 150 Z" className="illo-outline" />
			<path d="M230 112 L230 128 L160 166 L160 150 Z" className="illo-face-right" />
			<path d="M230 112 L230 128 L160 166 L160 150 Z" className="illo-outline" />
			...
			<path d="M147 48 l10 10 l17 -20" className="illo-celebrate-line" strokeWidth={4} />
...
export function FirstClientAddedHero() {
	return (
		<>
			<ellipse cx="160" cy="168" rx="78" ry="11" className="illo-mote" opacity={0.13} />
			...
			<path d="M86 116 L86 132 L160 174 L160 158 Z" className="illo-face-left" />
			<path d="M86 116 L86 132 L160 174 L160 158 Z" className="illo-outline" />
			<path d="M234 116 L234 132 L160 174 L160 158 Z" className="illo-face-right" />
			<path d="M234 116 L234 132 L160 174 L160 158 Z" className="illo-outline" />
			<path
