...
// Vendored from the ReUI registry (@reui/frame, base-nova style). Cleaned of the
// registry's stripped-premium radius/shadow class fragments (harmless no-ops like
// "(--radius-xl)]"); the free variant/spacing/stacked/dense API is kept verbatim.
// Only dep is class-variance-authority, so this is safe to hand-vendor.
//
// CSS variable architecture: the Frame parent sets --frame-panel-bg and
// --frame-panel-border-color; FramePanel consumes them via bg-(--frame-panel-bg)
// and border-(--frame-panel-border-color). A direct bg-*/border-* utility on a
// FramePanel wins by Tailwind source order — no `!` needed.
const frameVariants = cva(
	...
	],
	{
		variants: {
			...
			spacing: {
				xs: "[--frame-panel-px-base:--spacing(2)] [--frame-panel-py-base:--spacing(2)] [--frame-panel-header-px-base:--spacing(2)] [--frame-panel-header-py-base:--spacing(1)] [--frame-panel-footer-px-base:--spacing(2)] [--frame-panel-footer-py-base:--spacing(1)]",
				sm: "[--frame-panel-px-base:--spacing(3)] [--frame-panel-py-base:--spacing(3.5)] [--frame-panel-header-px-base:--spacing(3)] [--frame-panel-header-py-base:--spacing(2.5)] [--frame-panel-footer-px-base:--spacing(3)] [--frame-panel-footer-py-base:--spacing(2.5)]",
				default:
					"[--frame-panel-px-base:--spacing(4)] [--frame-panel-py-base:--spacing(4)] [--frame-panel-header-px-base:--spacing(4)] [--frame-panel-header-py-base:--spacing(3)] [--frame-panel-footer-px-base:--spacing(4)] [--frame-panel-footer-py-base:--spacing(3)]",
				lg: "[--frame-panel-px-base:--spacing(5)] [--frame-panel-py-base:--spacing(5)] [--frame-panel-header-px-base:--spacing(5)] [--frame-panel-header-py-base:--spacing(4)] [--frame-panel-footer-px-base:--spacing(5)] [--frame-panel-footer-py-base:--spacing(4)]",
			},
			stacked: {
				true: [
