...
// Result card lands at RESULT_AT (200) and settles by ~220; short hold after.
export { ASSISTANT_DURATION } from "../durations";

export const ASSISTANT_SHELL: SceneShell = {
	active: "Home",
	title: "Home",
	HeaderAction: () => <StatusBadge status="active" label="Assistant" />,
};
...
export const AssistantContent: React.FC = () => {
...
export const Assistant: React.FC = () => (
	<AbsoluteFill>
		<SceneFrame shell={ASSISTANT_SHELL}>
			<AssistantContent />
		</SceneFrame>
	</AbsoluteFill>
);

export default themed(Assistant);
