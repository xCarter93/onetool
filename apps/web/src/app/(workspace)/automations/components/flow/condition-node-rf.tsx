		...
		>
			...
			<BaseNodeContent className="p-3">
				<div className="flex items-center gap-3">
					<div className="w-8 h-8 rounded-lg bg-primary-soft text-primary-foreground flex items-center justify-center shrink-0">
						...
						{isFieldInvalid && (
							<div className="relative group">
								...
								<div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 hidden group-hover:block z-10">
									<div className="bg-warning-soft border border-warning/40 rounded-md px-2 py-1 text-xs font-semibold text-warning-foreground whitespace-nowrap">
