...
import type { UnifiedProjectDocument } from "./project-documents-section";
...
interface ProjectDocumentsModalProps {
	isOpen: boolean;
	onClose: () => void;
	documents: UnifiedProjectDocument[];
...
export function ProjectDocumentsModal({
	...
	const handleDelete = async (doc: UnifiedProjectDocument) => {
	...
	return (
		<Modal isOpen={isOpen} onClose={onClose} title="Project Documents" size="lg">
			{documents.length === 0 ? (
