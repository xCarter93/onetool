			...
			<>
				{!setup.canCopy && (
					<p className="mb-4 text-sm text-muted-foreground">
						This series is {setup.state}. Resume it to copy tasks to future
						projects.
					</p>
				)}
				{activeTemplates.length > 0 && (
					<FutureSetupSection
						...
						title="Future task setup"
						description="These tasks are added to new projects in this series."
					>
				...
				<DialogContent className="max-w-lg">
					...
					{previewError && (
						<SetupErrorAlert
							...
							onRetry={
								selection ? () => void loadPreview(selection) : undefined
							}
						/>
					)}
