...
### Phase 02.1: bulkCreate not working with new client import wizard (INSERTED)
...
Plans:
- [ ] 05-01-PLAN.md — PostHog analytics event constants and useImportWizard hook instrumentation
- [ ] 05-02-PLAN.md — ImportWizard embedded mode with state-based navigation and onComplete callback
- [ ] 05-03-PLAN.md — Onboarding page collapsible import section with embedded wizard and E2E verification
...
| 5. Fast Follows | 0/3 | Planning complete | - |
